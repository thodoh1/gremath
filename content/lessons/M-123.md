# Lesson M-123 — Even/odd identities
...
This lesson isolates **Even/odd identities** and trains it until it is automatic.
...
If you cannot do **Even/odd identities**, every later item that secretly uses it becomes a two-minute panic. The GRE will not name the skill. It will drop you into a computation or a “which statement is true?” and wait.
...
$\sin$ is odd, $\cos$ is even, $\tan$ is odd. Reciprocals inherit the parity of the originals (where defined).
...
**Drill 2.** Is $\sec$ even or odd?

**Solution.** Even, because $\cos$ is even.
...
Previous: [M-122](/lesson/M-122) — Pythagorean identities.

Next lesson: [M-124](/lesson/M-124) — Periodicity.
